<template>
	<div
		...
		<template v-if="label || $slots.default">
			<div class="base-separator__line base-separator__line--before"></div>
			<span class="base-separator__content" :style="spacingStyle">
				<slot>{{ label }}</slot>
			</span>
			<div class="base-separator__line base-separator__line--after"></div>
		</template>
	</div>
</template>
